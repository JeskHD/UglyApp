                    ...
                    <section class="Wrapper">
                        <article>
                            <div>
                                ...
                                <p class="uglydesc">Download Ugly Bros' art, music, and videos swiftly with UglyDownloader.</p>
                                <br>
...
async def progress(socketid):
    for x in range(1, 6):
        socketio.emit("progress", {'status': 'downloading', 'percent': x * 20}, to=socketid)
        await sleep(2)
    socketio.emit("progress", {'status': 'finished'}, to=socketid)
